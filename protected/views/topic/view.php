...
<div class="row">
	<div class="span8">
		<div class="dxd-topic-header">
				...
				<?php 
				echo CHtml::link((TopicFollow::model()->hasFollow(Yii::app()->user->id, $topic->id) ? '取消关注':'<i class="icon-plus  icon-white"></i>关注'),
		...
		<div class="tabbable"> <!-- Only required for left/right tabs -->
		  <ul class="nav nav-pills">
		    <li <?php if($type=='course'):?>class="active"<?php endif;?>><a href="#tab1" data-toggle="tab">课程</a></li>
		    <li <?php if($type=='question'):?>class="active"<?php endif;?>><a href="#tab2" data-toggle="tab">问答</a></li>
		  </ul>
	...
	<div class="dxd-topic-description-container">
		...
		<?php echo CHtml::link('取消','#',array('class'=>'pull-right dxd-topic-description-cancel btn dxd-topic-description-edit2','style'=>"display:none;"));?>	
		...
		<div class="pull-right" style="margin-top:5px">
			<?php if(Yii::app()->user->isGuest) echo CHtml::link('<i class="icon-pencil"></i>编辑','#',array('class'=>' dxd-topic-description-edit dxd-topic-description-edit1 muted','style'=>'margin-left:10px;'));?>
			<?php echo CHtml::link('<i class="icon-list"></i>历史',array('revisionHistory/topicDescription','topicid'=>$topic->id),array('class'=>' dxd-topic-descriptioin-revision  muted','style'=>'margin-left:10px;'));?>
		</div>
		<?php $this->endWidget();?>
