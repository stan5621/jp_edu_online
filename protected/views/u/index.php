<div class="row">
	<div style="border:1px solid #ccc;" class="span12">
    ...
    'label'=>'<i class="icon-envelope"></i>发私信',
//	'url'=>'javascript:openFancyBox("'.Yii::app()->createUrl('message/create',array('toUserId'=>$user->id)).'");',
   'url'=>array('message/create','toUserId'=>$user->id),
	...
	echo CHtml::link(($isFan ? '取消关注':'<i class="icon-plus icon-white"></i>关注'),
...
-->
	    <li class="active">
	    	...
	    	课程<span class="muted">&nbsp;<?php if($user->courseCount) echo $user->courseCount;?></span>
	    	</a>
	    </li>
	  </ul>
