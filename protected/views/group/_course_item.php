<li class="span2 dxd-group-course-item" style="width:192px;" courseId="<?php echo $data->id;?>" >
  <div class="thumbnail ">
  		<div class="dxd-course-operate">

  		  		 <?php	
  		  		 //在我的课表之外显示
  		  		 echo CHtml::link(($data->isCollector(Yii::app()->user->id)?'取消收藏':'收藏课程'),array(
	    ...
	    <tr><td><?php  echo $data->rateNum?>人评价</td><td>学员</td></tr>
	    <tr>
