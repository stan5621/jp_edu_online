<!--  
    ...
    <li class="active"><a href="#tab1" data-toggle="tab">讨论区</a></li>
    <li><a href="#tab2" data-toggle="tab">课程收藏区</a></li>
    </ul>
    ...
    <div class="tab-pane active" id="tab1">
			...
			<?php //echo CHtml::link('全部帖子',array('post/index','groupid'=>$group->id),array('class'=>'pull-right dxd-course-edit'));?>
				...
				<?php if($member->inRoles(array('superAdmin','admin','member'))){
					echo CHtml::link("<i class='icon-pencil'></i>发布新贴",array('addPost','id'=>$group->id),array('class'=>'btn'));
						}else{
					echo CHtml::tag('em',array(),'欢迎非小组成员参与回帖');
						}
						?>
				</div>		
