...
if(Yii::app()->user->id==$data->userId){
	echo CHtml::link("<i class='icon-remove' ></i>",array('courseFile/delete','id'=>$data->fileid),array('class'=>'pull-right dxd-hover-show','title'=>'删除','onclick'=>'deleteCourseFile(this);return false;'));
}
...
?>
<span class="muted pull-right" style="font-size:0.8em;">下载&nbsp;<?php echo $data->count_down;?>&nbsp;&nbsp;</span>
