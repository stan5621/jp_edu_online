<div class="dxd-course-header">	
	<div class="dxd-course-nav" style="border-top:none;padding-top:15px;padding-bottom:15px;">
		...
		?>
				<div style="margin-top:5px;"class="pull-right">创建者：<?php echo CHtml::link($group->superAdmin->name,array('//u/index','id'=>$group->superAdmin->id))?>&nbsp;&nbsp;&nbsp;成员&nbsp;<?php echo $group->memberNum;?>人&nbsp;&nbsp;
		</div>
		</div>
