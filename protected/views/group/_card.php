  ...
  <div class="thumbnail dxd-group-card">
  	...
  	<td style="width:70px;vertical-align:top">
	    ...
	    <?php $image = CHtml::image($imgUrl,'image',array('style'=>'width:60px;height:60px;','class'=>' '));
	    	echo CHtml::link($image,array('group/view','id'=>$data->id));?>
	</td>
	<td style="vertical-align:top">
	<div style="margin-bottom:5px">
	    <?php echo CHtml::link($data->name,array('group/view','id'=>$data->id));?>
		&nbsp;&nbsp;<span class="muted"><?php echo $data->memberCount?>成员</span>
</div>
	    <div>
