...
class DxdUtil{
     ...
     * @return string HTML link元素
     */
    public static function linkStyle($file)
    {
        if (isset(Yii::app()->theme->baseUrl) && is_file(Yii::app()->theme->basePath . DIRECTORY_SEPARATOR . $file)) {
            $result =   '<link rel="stylesheet" href="' . Yii::app()->baseUrl . DIRECTORY_SEPARATOR . $file . '">';
            $result .=  '<link rel="stylesheet" href="' . Yii::app()->theme->baseUrl . DIRECTORY_SEPARATOR . $file . '">';
            return $result;
        } else {
            return '<link rel="stylesheet" href="' . Yii::app()->baseUrl . DIRECTORY_SEPARATOR . $file . '">';
        }
    }
     ...
     *
     * @param string $file 文件路径
     * @return string HTML script元素
     */
    public static function linkScript($file)
    {
        if (isset(Yii::app()->theme->baseUrl) && is_file(Yii::app()->theme->basePath . DIRECTORY_SEPARATOR . $file)) {
            $result =   '<script type="text/javascript" src="' . Yii::app()->baseUrl . DIRECTORY_SEPARATOR . $file . '"></script>';
            $result .=  '<script type="text/javascript" src="' . Yii::app()->theme->baseUrl . DIRECTORY_SEPARATOR . $file . '"></script>';
            return $result;
        } else {
            return '<script type="text/javascript" src="' . Yii::app()->baseUrl . DIRECTORY_SEPARATOR . $file . '"></script>';
        }
    }
}
