...
class RennClientBase {
	 ...
	 * @return array
	 */
	public function getAuthorizeURL($redirectUri, $responseType = 'code', $status = null, $display = null, $forcelogin = null) {
		$params = array ();
		...
		return self::AUTHORIZATION_ENDPOINT . "?" . http_build_query ( $params )."&scope=publish_feed";
	}
