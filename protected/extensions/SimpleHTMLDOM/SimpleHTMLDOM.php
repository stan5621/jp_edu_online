<?php
/**
 *	Simple HTML DOM for Yii Framework
 *  By : Ary Wibowo (http://www.arywibowo.com)	
 *	Based on Simple HTML DOM
 */
include_once(dirname(__FILE__).'/SimpleHTMLDOMParser.php');
include_once(dirname(__FILE__).'/SimpleHTMLDOMNode.php');
/**
...
class SimpleHTMLDOM
{
	...
	public function file_get_html($url, $use_include_path = false, $context=null, $offset = -1, $maxLen=-1, $lowercase = true, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT, $defaultSpanText=DEFAULT_SPAN_TEXT)
	{
	    ...
	    $dom = new SimpleHTMLDOMParser(null, $lowercase, $forceTagsClosed, $target_charset, $stripRN, $defaultBRText, $defaultSpanText);
