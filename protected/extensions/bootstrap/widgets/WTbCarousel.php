 ...
 */
class WTbCarousel extends TbCarousel
{
	/**
	...
	public function renderIndicators(){
		...
		foreach($this->items as $index=>$item){
			echo '<li data-target="#'.$id.'" data-slide-to="'.$index.'" class="'.($index===0?'active':"").'"></li>';
		}
		echo '</ol>';
	}
	/**
