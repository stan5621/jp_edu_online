...
class NavController extends Controller
{
	 ...
	 */
	public $layout='//layouts/nonav_column2';
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('Nav',array('criteria'=>array('order'=>'weight asc')));
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='nav-form')
		{
