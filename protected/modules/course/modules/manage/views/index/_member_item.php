...
<div>
	...
	echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$data->user->bio;
	echo CHtml::link('剔出课程',array('deleteMember','id'=>$course->id,'userId'=>$data->userId),array('class'=>'btn pull-right'));
	echo CHtml::link('编辑',array('editMember','id'=>$course->id,'userId'=>$data->userId),array('class'=>'btn pull-right dxd-fancy-elem','data-fancyWidth'=>350,'data-fancyHeight'=>180));
