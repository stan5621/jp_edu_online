...
<div class="row ">
    ...
    <!-- Main 内容区域 -->
	<div class="span10">
        <h3 class="side-lined">公告管理</h3>
        <?php echo CHtml::link('<i class="icon-plus icon-white"></i>添加公告', array('create', 'courseId'=>$course->id), array('class'=>'btn btn-success mr10', 'onclick'=>'openFancyBox(this);return false;')); ?>
