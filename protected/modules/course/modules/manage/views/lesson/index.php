...
<div class="row ">
	...
	<div class="span10">
		<h3 class="side-lined">课时管理</h3>
		<div style="position:static;top:auto">
		<?php 
			echo CHtml::link('<i class="icon-plus icon-white"></i>添加章节',array('chapter/create','courseId'=>$course->id),array('class'=>'btn btn-success   mr10','onclick'=>'openFancyBox(this);return false;'));
			echo CHtml::link('<i class="icon-plus icon-white"></i>添加课时',array('create','courseId'=>$course->id),array('class'=>'btn btn-success   mr10','onclick'=>'openFancyBox(this);return false;'));
			echo CHtml::link('<i class="icon-plus icon-white"></i>批量导入视频链接',array('createMany','courseId'=>$course->id),array('class'=>'btn btn-success dxd-fancy-elem mr10'));
		?>
    ...
    //    'type'=>'primary', // '', 'primary', 'info', 'success', 'warning', 'danger' or 'inverse'
        'buttons'=>array(
            array('label'=>'批量操作', 'url'=>'#'),
            array('items'=>array(
                array('label'=>'发布全部课时', 'url'=>array('publishAll','courseId'=>$course->id)),
                array('label'=>'隐藏全部课时', 'url'=>array('hideAll','courseId'=>$course->id)),
            )),
        ),
    )); ?>
    </div>
