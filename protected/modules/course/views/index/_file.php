		<div class="dxd-dashboard-panel">
			...
			<div class="dxd-panel-content">
				<?php if(Yii::app()->user->id==$course->userId) echo CHtml::link("<i class='icon-upload'></i>上传文件",array('courseFile/create','courseId'=>$course->id),array('class'=>'btn pull-right dxd-fancy-elem'));?>
