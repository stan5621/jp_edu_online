...
<div>
	...
	&nbsp;&nbsp;<small class="muted">
		<?php echo date('Y-m-d H:i',$data->addTime);?></small>
	<div style="margin:5px 0;">
	<?php echo $data->content;?>
	</div>
	<div>
		<div class="pull-left muted"><small>来自课程***</small></div>
		<?php echo CHtml::link('回复','javascript:;',array('class'=>'muted pull-right','data-toggle'=>'collapse','data-target'=>'#dxd-comment-form-'.$index));?>
		<div class="clearfix"></div>
	</div>
	<div id="dxd-comment-form-<?php echo $index;?>" class="collapse">
		<?php  $this->renderPartial('_comment_form',array('comment'=>$data,'commentableEntityId'=>$data->commentableEntityId));?>
	</div>
	<?php if($data->refer){ ?>
