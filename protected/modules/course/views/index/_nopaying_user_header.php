...
<div class="dxd-course-header">	
	<div class="dxd-course-nav" style="border-top:none;padding-top:15px;padding-bottom:15px;">
		...
		<div class="dxd-course-header-left2" style="text-align:center;padding:20px 20px 0 20px;">
			...
			<div>
				<?php 
					echo CHtml::link('选修课程&nbsp;&nbsp; <span class="badge badge-info course-price" style="top:1px;">￥'.$course->fee.'</span>',array('buy','id'=>$course->id),array('class'=>'btn btn-large btn-warning btn-course-pay'));
					?>
			</div>
		</div>
		...
		<?php 
			...
			echo CHtml::link(($course->isCollector(Yii::app()->user->id)?'取消收藏':'收藏课程'),array(
