...
<div>
	...
	<div style="margin-left:56px">
		...
		<?php echo CHtml::link('<i class="icon-comment"></i>&nbsp;'.$data->commentNum.'&nbsp;回复',array('post/view','id'=>$data->id),array('class'=>"pull-right muted",'target'=>'_blank'));?>
		
		<?php if(isset($showSource) && $showSource && isset($data->lesson->title)):?>
			<?php echo Chtml::link('源自&nbsp;'.$data->lesson->title."&nbsp;&nbsp;",array('lesson/view','id'=>$data->lessonId),array('class'=>'muted pull-right'));?>
		<?php endif;?>
