...
<div class="dxd-public-lesson-note">
		...
		<!-- 公共笔记结束-->
				...
				<!-- 为公共笔记添加感谢 -->
		<div>
			<?php echo CHtml::link(' ',array('vote/lessonNote','noteid'=>$data->id),array('rel'=>'tooltip','data-title'=>'对我有用','class'=>'pull-left dxd-lesson-note-vote dxd-post-up '.($data->voteNum ? "dxd-voted" : "")));?>&nbsp;&nbsp;
