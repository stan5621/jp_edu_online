<div class="item">
    ...
    <!-- 帖子数据 -->
    <div class="data">
        <?php echo CHtml::link(mb_substr($data->title, 0, 24, 'utf-8'), array('//group/post/view', 'id'=>$data->id), array('class'=>'title')); ?>
        <div class="content">
        ...
        <div class="info">
           ...
           <?php echo DxdUtil::duration2Day(time() - $data->addTime);?>
            ...
            于<?php echo DxdUtil::duration2Day(time() - $data->upTime); ?>
            <?php endif;?>
