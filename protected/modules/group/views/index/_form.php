...
//	'action'=>array('question/create'),
	...
	<div class="row">
		<?php // echo $form->dropDownListRow($model,'courseId',array('1'=>'a','2')); ?>
	</div>
...
//			array('template'=>'{input}{label}','separator'=>"&nbsp;&nbsp;&nbsp;&nbsp;"));
		...
		?>
		    ...
		    <?php //echo $form->radioButtonListRow($model, 'joinType', array('free'=>'自由加入','apply'=>'审核加入')); ?>
		<style type="text/css">
...
<br/>
    ...
    'type'=>'primary',
    'label'=>$model->isNewRecord ? '下一步' : '保存',
    'buttonType'=>'submit',
