...
//    echo CHtml::link(,array('u/index','id'=>$data->userId),array('class'=>'dxd-name','data-userId'=>$data->userId,'style'=>'margin-top:5px;'));
	...
	echo CHtml::ajaxLink('剔出小组',array('groupMember/delete','groupid'=>$group->id,'userId'=>$data->userId),array('success'=>'js:function(data){window.location.reload();}'),array('class'=>'btn  pull-right'));
	?>
