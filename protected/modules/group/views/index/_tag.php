<div style="margin-bottom:15px">
	...
	<span class="dxd-topics dxd-topics editable" id="dxd-topics-editable-1"
	    ...
	    data-value="<?php echo $group->getTagNamesString();?>" data-original-title="编辑话题"></span>
	...
	<?php endif;?>
	&nbsp;&nbsp;<?php echo CHtml::link('<i class="icon-list"></i>历史',array('revisionHistory/coursetopic','courseId'=>$group->id),array('class'=>' dxd-course-topic-revision muted'));?>        	
</div>
