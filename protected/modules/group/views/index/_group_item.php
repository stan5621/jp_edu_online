<li class="span2" courseId="<?php echo $data->id;?>" style="background-color:#ececec" >
	<div class="group-card" style="margin-bottom:20px">
	   ...
	   <div class="text-center">
	    	<?php //echo CHtml::link(mb_substr($data->name,0,32,'utf-8'),array('//course/index/view','id'=>$data->id),array('style'=>""));?>
	   		...
	   		<div class="muted"><small>			<?php echo $data->memberNum;?>&nbsp;成员</small>
	   		</div>
	   		<div style="margin-top:20px">
	    	<?php echo CHtml::link('+ 加入小组',array('view','id'=>$data->id),array('class'=>'group-card-join light-green'));?>
	   		</div>
	    </div>
    	</div>
</li>