 ...
 <?php echo $form->radioButtonListRow($model, 'means', array(
    ...
    <hr/>
     <?php /*echo $form->radioButtonListRow($model, 'aliEnabled', array(
		...
		<?php echo $form->textFieldRow($model,'aliSellerAccount',array('value'=>$model->aliSellerAccount)); ?>

		<?php echo $form->textFieldRow($model,'aliPartner',array('value'=>$model->aliPartner)); ?>

		<?php echo $form->textFieldRow($model,'aliKey',array('value'=>$model->aliKey)); ?>
