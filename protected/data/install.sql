...
--
-- Host: localhost    Database: eduwindos
-- ------------------------------------------------------
...
CREATE TABLE `ew_answer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=298 DEFAULT CHARSET=utf8 COMMENT='选项';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_cms_people` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 COMMENT='教师表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_comment` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=176 DEFAULT CHARSET=utf8 COMMENT='评论';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_course` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='课程表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='选课成员';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_course_post` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='讨论区帖子';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_entity` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=560 DEFAULT CHARSET=utf8 COMMENT='可挂载对象';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_follow` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=93 DEFAULT CHARSET=utf8 COMMENT='关注表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_group` (
  ...
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  `deleteTime` int(11) NOT NULL DEFAULT '0',
  `teaderTitle` char(255) NOT NULL DEFAULT '组长',
  `adminTitle` char(255) NOT NULL DEFAULT '管理员',
  `memberTitle` char(255) NOT NULL DEFAULT '会员',
  `leaderTitle` char(32) NOT NULL DEFAULT '组长',
  PRIMARY KEY (`id`),
  UNIQUE KEY `postableEntityId` (`postableEntityId`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='小组表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_group_member` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COMMENT='用户从属关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_lesson` (
  ...
  PRIMARY KEY (`id`),
  KEY `courseId` (`courseId`)
) ENGINE=MyISAM AUTO_INCREMENT=214 DEFAULT CHARSET=utf8 COMMENT='课时表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_lesson_doc` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='课时文档资料';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_note` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='笔记表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_notice` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=110 DEFAULT CHARSET=utf8 COMMENT='提醒，通知';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_page` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='静态页面';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_system_setting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='系统设置值表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='用来记录网站升级包的信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_upload_file` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=68 DEFAULT CHARSET=utf8 COMMENT='文件';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_user` (
  ...
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  `deleteTime` int(11) NOT NULL DEFAULT '0',
  `sessionId` char(32) NOT NULL DEFAULT '' COMMENT '保存用户最近的一个sessionId',
  `lastAccessTime` int(11) NOT NULL DEFAULT '0' COMMENT '从课程界面最近的一次访问时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `ew_user_info` (
  ...
  `tmpEmail` char(64) NOT NULL DEFAULT '' COMMENT '暂存email，用于社交网站开放登录',
  `sex` char(8) NOT NULL DEFAULT '' COMMENT '性别',
  `entityId` int(11) NOT NULL DEFAULT '0' COMMENT 'Entity对象Id',
  `isTeacher` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否老师',
  `teacherIntroduction` text COMMENT '老师介绍',
